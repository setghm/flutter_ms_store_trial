...
class DevModeApp extends StatefulWidget {
  const DevModeApp({super.key});

  @override
  State<DevModeApp> createState() => _DevModeAppState();
}

class _DevModeAppState extends State<DevModeApp> {
      ...
      if (mounted) {
        if (_productResponse!.product == null) {
          ...
          _extendedProductJsonController.text =
              _productResponse!.product!.extendedJsonData;
        }
  ...
  Widget _buildProductInfo(BuildContext context) {
    if (_productResponse!.product != null) {
      final isFree = _productResponse!.product!.isFree;
      ...
      return Column(
        ...
        children: [
          ...
          Text(
            isFree
                ? 'App is free'
                : 'Price: ${_productResponse!.product!.price}',
          ),
        ],
      );
    }
